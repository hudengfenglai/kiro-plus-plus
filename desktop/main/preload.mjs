...
contextBridge.exposeInMainWorld("kiroPlusApp", {
  ...
  exportWorkbenchSnapshot: (markdownText) => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsExportWorkbench, markdownText),
  clearDiagnosticsHistory: () => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsClearHistory),
  clearMissingDiagnosticsHistory: () => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsClearMissingHistory),
  clearWorkbenchExportHistory: () => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsClearWorkbenchHistory),
  clearMissingWorkbenchExportHistory: () => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsClearMissingWorkbenchHistory),
  selectDiagnosticsBundle: (bundleName) => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsSelectBundle, bundleName),
  deleteDiagnosticsBundle: (bundleName) => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsDeleteBundle, bundleName),
  deleteWorkbenchExport: (filePath) => ipcRenderer.invoke(IPC_CHANNELS.diagnosticsDeleteWorkbench, filePath),
